Public Class TiposAssistencias
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents dtgTiposAssistencias As System.Windows.Forms.DataGridView
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(TiposAssistencias))
        ...
        Me.dtgTiposAssistencias = New System.Windows.Forms.DataGridView
        ...
        CType(Me.dtgTiposAssistencias, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.gpDados.Size = New System.Drawing.Size(568, 166)
        ...
        Me.btConfirmaSelecao.Location = New System.Drawing.Point(408, 136)
        ...
        Me.txtDataCadastro.Location = New System.Drawing.Point(124, 112)
        ...
        Me.btCancelaSelecao.Location = New System.Drawing.Point(488, 136)
        ...
        Me.cbUsuarioCadastro.Location = New System.Drawing.Point(124, 136)
        ...
        Me.Label6.Text = "Descrição Serviço"
        ...
        'tpConsulta
        '
        Me.tpConsulta.Controls.Add(Me.dtgTiposAssistencias)
        ...
        '
        'dtgTiposAssistencias
        '
        Me.dtgTiposAssistencias.AllowUserToAddRows = False
        Me.dtgTiposAssistencias.AllowUserToDeleteRows = False
        Me.dtgTiposAssistencias.AllowUserToOrderColumns = True
        Me.dtgTiposAssistencias.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill
        Me.dtgTiposAssistencias.ColumnHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.None
        ...
        Me.dtgTiposAssistencias.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle1
        Me.dtgTiposAssistencias.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize
        Me.dtgTiposAssistencias.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() {Me.Cm})
        Me.dtgTiposAssistencias.Location = New System.Drawing.Point(7, 87)
        Me.dtgTiposAssistencias.Name = "dtgTiposAssistencias"
        Me.dtgTiposAssistencias.RowHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.None
        ...
        Me.dtgTiposAssistencias.RowHeadersDefaultCellStyle = DataGridViewCellStyle2
        Me.dtgTiposAssistencias.Size = New System.Drawing.Size(744, 335)
        Me.dtgTiposAssistencias.TabIndex = 1
        '
        'Cm
        '
        Me.Cm.HeaderText = "Cm"
        ...
        Me.Name = "TiposAssistencias"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Cadastro de Tipos de Assistências"
        ...
        CType(Me.dtgTiposAssistencias, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Public objTiposAssistencias_Implem As TiposAssistencias_Implem = TiposAssistenciasBOFactory.GetFactory().GetInstance()
...
#Region " Inicializações "
    ...
    Private Sub TiposAssistencias_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If vSelecao <> "" Then
                ...
                If dtgTiposAssistencias.Rows.Count = 1 Then
                    dtgTiposAssistencias.Rows(0).Selected = True
                    Me.Close()
                End If
            Else
    ...
    Private Sub CadastroTiposAssistencias_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        objTiposAssistencias_Implem = Nothing
        LimpaErros()
    End Sub
    ...
    Protected Overrides Sub OnKeyDown(ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        End If
        If e.KeyCode = Keys.Enter And dtgTiposAssistencias.Focused Then
...
#Region " Adicionar/Alterar /Excluir Empresa "
    ...
    Public Function GuardaDadosTiposAssistencias() As Integer
        Try
            objTiposAssistencias_Implem.Codigo = Replace(txtCodigo.Text, "'", "''")
            objTiposAssistencias_Implem.Descricao = Replace(txtNome.Text, "'", "''")

            objTiposAssistencias_Implem.Codigo_Usuario_Cadastro = cbUsuarioCadastro.SelectedItem.value
    ...
    Public Sub TelaAlteracaoTiposAssistencias()
        Try
            ...
            txtCodigo.Text = objTiposAssistencias_Implem.Codigo
            txtNome.Text = objTiposAssistencias_Implem.Descricao

            txtDataCadastro.Text = ConverteDataHoraParaString(objTiposAssistencias_Implem.Data_Hora_Cadastro)
            objVariaveisGlobais.SetaComboBox(cbUsuarioCadastro, objTiposAssistencias_Implem.Codigo_Usuario_Cadastro)
    ...
    Public Sub AdicionarTiposAssistencias()
        Try
            ...
            wControle = objTiposAssistencias_Implem.IncluirAssistencia
            If wControle = 1 Then
                MessageBox.Show("Já existe um Serviço cadastrado com este Codigo!", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If
            MessageBox.Show("Serviço incluído com sucesso! Numero: " & _
                        objTiposAssistencias_Implem.Codigo, "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Public Sub Alterar()
        ...
        Try
            ...
            wControle = objTiposAssistencias_Implem.AlterarAssistencia
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If
    ...
    Private Sub Excluir()
        ...
        wMensagem = MessageBox.Show("TODOS Dados relacionados a esse Serviço serão permanentemente excluídos!" & vbCrLf & " Você deseja excluir este Serviço? ", "Confirmação", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button2)
        If (wMensagem = Windows.Forms.DialogResult.Yes) Then
            objTiposAssistencias_Implem.Codigo = txtCodigo.Text
            wControle = objTiposAssistencias_Implem.ExcluirAssistencia
            If wControle < 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            ElseIf wControle > 0 Then
                MsgBox("Serviço Possui Movimento Ativo! ")
                Exit Sub
            End If
...
#Region " Atualização do DataGrid e do Form "
    ...
    Private Sub AtualizaTiposAssistencias()
        ...
        wControle = objTiposAssistencias_Implem.MostraTabelaTiposAssistencias(dtgTiposAssistencias, wSQL)
    ...
    Private Sub PreencheCampoPesquisa()
        If cbCampo.Items.Count = 0 Then
            ...
            For i As Integer = 0 To dtgTiposAssistencias.Columns.Count - 1
                If dtgTiposAssistencias.Columns(i).ValueType.ToString = GetType(String).ToString AndAlso dtgTiposAssistencias.Columns(i).Visible = True Then
                    c = New System.Web.UI.WebControls.ListItem
                    c.Value = dtgTiposAssistencias.Columns(i).HeaderText
                    c.Text = dtgTiposAssistencias.Columns(i).HeaderText
                    cbCampo.Items.Add(c)
                End If
            Next
    ...
    Private Sub cbTiposAssistenciasPesquisaEstado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbCampo.SelectedIndexChanged
        FazFiltro()
    End Sub
    ...
    Function FazFiltro()
        If Not IsNothing(dtgTiposAssistencias.DataSource) Then
            ...
            For i As Integer = 0 To dtgTiposAssistencias.Columns.Count - 1
                If dtgTiposAssistencias.Columns(i).Name = cbCampo.Text Then
                    wValida = True
                    Exit For
                End If
            Next
            ...
            wDataTable = objTiposAssistencias_Implem.wDataSet.Tables(0)
            Dim wDataView = New DataView(wDataTable, _
                     wPesquisa, _
                     "", DataViewRowState.CurrentRows)
            dtgTiposAssistencias.DataSource = wDataView
        End If
        Return True
    End Function

    Private Sub dtgTiposAssistencias_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles dtgTiposAssistencias.MouseMove
        Try
            Dim hti As System.Windows.Forms.DataGridView.HitTestInfo
            hti = dtgTiposAssistencias.HitTest(e.X, e.Y)
            ...
            If hti.Type = System.Windows.Forms.DataGrid.HitTestType.Cell Then
                ...
                End If
                If hti.ColumnIndex = 2 Then
                    ToolTip1.SetToolTip(dtgTiposAssistencias, "")
                End If
            Else
                Me.Cursor = System.Windows.Forms.Cursors.Default
                Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    ...
    Private Sub dtgTiposAssistencias_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles dtgTiposAssistencias.MouseUp
        Try
            Dim hti As DataGridView.HitTestInfo = dtgTiposAssistencias.HitTest(e.X, e.Y)
    ...
    Private Sub dtgTiposAssistencias_CurrentCellChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtgTiposAssistencias.CurrentCellChanged
        Try
            Dim wControle As Integer
            If IsNothing(dtgTiposAssistencias.DataSource) Or IsNothing(dtgTiposAssistencias.CurrentCell) Then Exit Sub

            objTiposAssistencias_Implem.Codigo = dtgTiposAssistencias.Item(0, dtgTiposAssistencias.CurrentCell().RowIndex).Value
            wControle = objTiposAssistencias_Implem.BuscarAssistencia
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If
            dtgTiposAssistencias.Rows(dtgTiposAssistencias.CurrentCell().RowIndex).Selected = True
            dtgTiposAssistencias.Focus()
        Catch ex As Exception
            VariaveisGlobais.gUltimoSQL = ""
            VariaveisGlobais.gDescricaoUltimoErro = ex.Message
...
#Region " Valida da tela "
    ...
    Private Sub txtNome_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtNome.Validating
        Dim wMsgErro As String = "Digite o Nome do Serviço!"
...
#End Region
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) _
        ...
        If mpreview = False Then
            ...
            dados = 0
        End If
        TotalRecords = dtgTiposAssistencias.RowCount
    ...
    Private Sub PrintDocument2_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        For i As Integer = ContadorRegistro To TotalRecords - 1
            ...
            Codigo = dtgTiposAssistencias.Item(0, i).Value
            Nome = dtgTiposAssistencias.Item(1, i).Value
    ...
    Private Sub MontaCabecalho(ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        e.Graphics.DrawString("Relatório de Tipos de Serviços", printFontB, sdb, 390, 55, dFac)
        ...
        e.Graphics.DrawString("Tipo de Serviço", printFontB, sdb, 80, 120)
