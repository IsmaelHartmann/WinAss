...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents dtgAnimais As System.Windows.Forms.DataGridView
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.dtgAnimais = New System.Windows.Forms.DataGridView
        ...
        CType(Me.dtgAnimais, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.gpDados.Text = "Informações do Animal"
        '
        'btConfirmaSelecao
        '
        ...
        Me.txtDataCadastro.Location = New System.Drawing.Point(124, 77)
        ...
        Me.cbUsuarioCadastro.Location = New System.Drawing.Point(124, 101)
        ...
        'tpConsulta
        '
        Me.tpConsulta.Controls.Add(Me.dtgAnimais)
        ...
        'dtgAnimais
        '
        Me.dtgAnimais.AllowUserToAddRows = False
        Me.dtgAnimais.AllowUserToDeleteRows = False
        Me.dtgAnimais.AllowUserToOrderColumns = True
        Me.dtgAnimais.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill
        Me.dtgAnimais.ColumnHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.None
        ...
        Me.dtgAnimais.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle1
        Me.dtgAnimais.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize
        Me.dtgAnimais.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() {Me.Cm})
        Me.dtgAnimais.Location = New System.Drawing.Point(7, 87)
        Me.dtgAnimais.Name = "dtgAnimais"
        Me.dtgAnimais.RowHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.None
        ...
        Me.dtgAnimais.RowHeadersDefaultCellStyle = DataGridViewCellStyle2
        Me.dtgAnimais.Size = New System.Drawing.Size(744, 335)
        Me.dtgAnimais.TabIndex = 1
        '
        'Cm
        '
        Me.Cm.HeaderText = "Cm"
        ...
        CType(Me.dtgAnimais, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Public objAnimais_Implem As Animais_Implem = AnimaisBOFactory.GetFactory().GetInstance()
...
#Region " Inicializações "
    ...
    Private Sub Animais_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim autoriza As Boolean
        autoriza = VerificaPrograma("Animais", VariaveisGlobais.gSetorUsuario, _
        ...
        Try
            ...
            If vSelecao <> "" Then
                ...
                If dtgAnimais.Rows.Count = 1 Then
                    dtgAnimais.Rows(0).Selected = True
                    Me.Close()
                End If
            Else
    ...
    Private Sub CadastroAnimais_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        objAnimais_Implem = Nothing
        LimpaErros()
    End Sub

    Private Sub Animais_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Protected Overrides Sub OnKeyDown(ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.F1 Then
            objLeituras.VerC_LOG(VariaveisGlobais.gBD, "C_LOG", "Ass_Animais", txtCodigo.Text)
        End If
        ...
        End If
        If e.KeyCode = Keys.Enter And dtgAnimais.Focused Then
            TelaAlteracaoAnimais()
...
#Region " Adicionar/Alterar /Excluir Empresa "
    ...
    Public Function GuardaDadosAnimais() As Integer
        Try
            objAnimais_Implem.Codigo = Replace(txtCodigo.Text, "'", "''")
            objAnimais_Implem.NomeAnimal = Replace(txtNome.Text, "'", "''")

            objAnimais_Implem.Codigo_Usuario_Cadastro = cbUsuarioCadastro.SelectedItem.value
    ...
    Public Sub TelaAlteracaoAnimais()
        Try
            Dim wControle As Integer
            LimpaErros()
            ...
            txtCodigo.Text = objAnimais_Implem.Codigo
            txtNome.Text = objAnimais_Implem.NomeAnimal

            txtDataCadastro.Text = ConverteDataHoraParaString(objAnimais_Implem.Data_Hora_Cadastro)
            objVariaveisGlobais.SetaComboBox(cbUsuarioCadastro, objAnimais_Implem.Codigo_Usuario_Cadastro)
    ...
    Public Sub AdicionarAnimais()
        Try
            ...
            GuardaDadosAnimais()
            wControle = objAnimais_Implem.IncluirAnimal
            If wControle = 1 Then
                MessageBox.Show("Já existe um Animal cadastrado com este Codigo!", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If
            MessageBox.Show("Animal incluído com sucesso! Numero: " & _
                        objAnimais_Implem.Codigo, "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Public Sub Alterar()
        ...
        Try
            ...
            wControle = GuardaDadosAnimais()
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If

            wControle = objAnimais_Implem.AlterarAnimal
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If
            MessageBox.Show("Dados do Animal modificados com sucesso!", "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub Excluir()
        ...
        wMensagem = MessageBox.Show("TODOS Dados relacionados a esse Animal serão permanentemente excluídos!" & vbCrLf & " Você deseja excluir este Animal? ", "Confirmação", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button2)
        If (wMensagem = Windows.Forms.DialogResult.Yes) Then
            objAnimais_Implem.Codigo = txtCodigo.Text
            wControle = objAnimais_Implem.ExcluirAnimal
            If wControle < 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            ElseIf wControle = 1 Then
                MsgBox("Animal Possui Movimento Ativo! ")
                Exit Sub
            End If
...
#Region " Atualização do DataGrid e do Form "
    ...
    Private Sub AtualizaAnimais()
        ...
        wControle = objAnimais_Implem.MostraTabelaAnimais(dtgAnimais, wSQL)
    ...
    Private Sub PreencheCampoPesquisa()
        If cbCampo.Items.Count = 0 Then
            ...
            For i As Integer = 0 To dtgAnimais.Columns.Count - 1
                If dtgAnimais.Columns(i).ValueType.ToString = GetType(String).ToString AndAlso dtgAnimais.Columns(i).Visible = True Then
                    c = New System.Web.UI.WebControls.ListItem
                    c.Value = dtgAnimais.Columns(i).HeaderText
                    c.Text = dtgAnimais.Columns(i).HeaderText
                    cbCampo.Items.Add(c)
                End If
            Next
    ...
    Private Sub cbAnimaisPesquisaEstado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbCampo.SelectedIndexChanged
        FazFiltro()
    End Sub
    ...
    Function FazFiltro()
        If Not IsNothing(dtgAnimais.DataSource) Then
            Dim wDataTable As New DataTable
            Dim wPesquisa As String = ""
            Dim wValida As Boolean = False
            ...
            End If
            wDataTable = objAnimais_Implem.wDataSet.Tables(0)

            For i As Integer = 0 To dtgAnimais.Columns.Count - 1
                If dtgAnimais.Columns(i).Name = cbCampo.Text Then
                    wValida = True
                    Exit For
                End If
            Next
            ...
            dtgAnimais.DataSource = wDataView
        End If
        Return True
    End Function

    Private Sub dtgAnimais_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles dtgAnimais.MouseMove
        Try
            Dim hti As System.Windows.Forms.DataGridView.HitTestInfo
            hti = dtgAnimais.HitTest(e.X, e.Y)
            ...
            If hti.Type = System.Windows.Forms.DataGrid.HitTestType.Cell Then
                ...
                End If
                If hti.ColumnIndex = 2 Then
                    ToolTip1.SetToolTip(dtgAnimais, "")
                End If
            Else
                Me.Cursor = System.Windows.Forms.Cursors.Default
                Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    ...
    Private Sub dtgAnimais_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles dtgAnimais.MouseUp
        Try
            Dim hti As DataGridView.HitTestInfo = dtgAnimais.HitTest(e.X, e.Y)
    ...
    Private Sub dtgAnimais_CurrentCellChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtgAnimais.CurrentCellChanged
        Try
            Dim wControle As Integer
            If IsNothing(dtgAnimais.DataSource) Or IsNothing(dtgAnimais.CurrentCell) Then Exit Sub

            objAnimais_Implem.Codigo = dtgAnimais.Item(0, dtgAnimais.CurrentCell().RowIndex).Value
            wControle = objAnimais_Implem.BuscarAnimal
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If
            dtgAnimais.Rows(dtgAnimais.CurrentCell().RowIndex).Selected = True
            dtgAnimais.Focus()
        Catch ex As Exception
            VariaveisGlobais.gUltimoSQL = ""
            VariaveisGlobais.gDescricaoUltimoErro = ex.Message
...
#Region " Valida da tela "
    ...
    Private Sub txtNome_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtNome.Validating
        Dim wMsgErro As String = "Digite o Nome do Animal!"
...
#End Region
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) _
        ...
        If mpreview = False Then
            ...
            dados = 0
        End If
        TotalRecords = dtgAnimais.RowCount
    ...
    Private Sub PrintDocument2_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        For i As Integer = ContadorRegistro To TotalRecords - 1
            ...
            Codigo = dtgAnimais.Item(0, i).Value
            Nome = dtgAnimais.Item(1, i).Value
    ...
    Private Sub MontaCabecalho(ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        e.Graphics.DrawString("Relatório de Animais", printFontB, sdb, 390, 55, dFac)
        ...
        e.Graphics.DrawString("Nome do Animal", printFontB, sdb, 80, 120)
