...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents dtgTecnicos As System.Windows.Forms.DataGridView
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.dtgTecnicos = New System.Windows.Forms.DataGridView
        ...
        CType(Me.dtgTecnicos, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.gpDados.Size = New System.Drawing.Size(568, 169)
        Me.gpDados.TabIndex = 0
        Me.gpDados.TabStop = False
        Me.gpDados.Text = "Informações do Técnico"
        '
        'txtCRMV
        '
        Me.txtCRMV.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
        Me.txtCRMV.Location = New System.Drawing.Point(124, 78)
        Me.txtCRMV.Name = "txtCRMV"
        Me.txtCRMV.Size = New System.Drawing.Size(72, 20)
        ...
        Me.btConfirmaSelecao.Location = New System.Drawing.Point(408, 141)
        ...
        Me.txtDataCadastro.Location = New System.Drawing.Point(122, 116)
        ...
        Me.btCancelaSelecao.Location = New System.Drawing.Point(488, 141)
        ...
        Me.cbUsuarioCadastro.Location = New System.Drawing.Point(122, 140)
        ...
        'tpConsulta
        '
        Me.tpConsulta.Controls.Add(Me.dtgTecnicos)
        ...
        'dtgTecnicos
        '
        Me.dtgTecnicos.AllowUserToAddRows = False
        Me.dtgTecnicos.AllowUserToDeleteRows = False
        Me.dtgTecnicos.AllowUserToOrderColumns = True
        Me.dtgTecnicos.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill
        Me.dtgTecnicos.ColumnHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.None
        ...
        Me.dtgTecnicos.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle1
        Me.dtgTecnicos.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize
        Me.dtgTecnicos.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() {Me.Cm})
        Me.dtgTecnicos.Location = New System.Drawing.Point(7, 87)
        Me.dtgTecnicos.Name = "dtgTecnicos"
        Me.dtgTecnicos.RowHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.None
        ...
        Me.dtgTecnicos.RowHeadersDefaultCellStyle = DataGridViewCellStyle2
        Me.dtgTecnicos.Size = New System.Drawing.Size(744, 335)
        Me.dtgTecnicos.TabIndex = 1
        '
        'Cm
        '
        Me.Cm.HeaderText = "Cm"
        ...
        CType(Me.dtgTecnicos, System.ComponentModel.ISupportInitialize).EndInit()
...
#Region " Inicializações "
    ...
    Private Sub Tecnicos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        autoriza = VerificaPrograma("Tecnicos", VariaveisGlobais.gSetorUsuario, _
        ...
        Try
            ...
            If vSelecao <> "" Then
                ...
                If dtgTecnicos.Rows.Count = 1 Then
                    dtgTecnicos.Rows(0).Selected = True
                    Me.Close()
                End If
            Else
    ...
    Private Sub CadastroTecnicos_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        objTecnicos_Implem = Nothing
        LimpaErros()
    End Sub
    ...
    Protected Overrides Sub OnKeyDown(ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.F1 Then
            objLeituras.VerC_LOG(VariaveisGlobais.gBD, "C_LOG", "Ass_Tecnicos", txtCodigo.Text)
        End If
        ...
        End If
        If e.KeyCode = Keys.Enter And dtgTecnicos.Focused Then
            TelaAlteracaoTecnicos()
...
#Region " Adicionar/Alterar /Excluir Empresa "
    ...
    Public Function GuardaDadosTecnicos() As Integer
        Try
            objTecnicos_Implem.Codigo = Replace(txtCodigo.Text, "'", "''")
            objTecnicos_Implem.CRMV = Replace(txtCRMV.Text, "'", "''")
            objTecnicos_Implem.NomeTecnico = Replace(txtNome.Text, "'", "''")

            objTecnicos_Implem.Codigo_Usuario_Cadastro = cbUsuarioCadastro.SelectedItem.value
    ...
    Public Sub TelaAlteracaoTecnicos()
        Try
            Dim wControle As Integer
            LimpaErros()
            ...
            txtCodigo.Text = objTecnicos_Implem.Codigo
            txtCRMV.Text = objTecnicos_Implem.CRMV
            txtNome.Text = objTecnicos_Implem.NomeTecnico

            txtDataCadastro.Text = ConverteDataHoraParaString(objTecnicos_Implem.Data_Hora_Cadastro)
            objVariaveisGlobais.SetaComboBox(cbUsuarioCadastro, objTecnicos_Implem.Codigo_Usuario_Cadastro)
    ...
    Public Sub AdicionarTecnicos()
        Try
            ...
            GuardaDadosTecnicos()
            wControle = objTecnicos_Implem.IncluirTecnico
            If wControle = 1 Then
                MessageBox.Show("Já existe um Técnico cadastrado com este Codigo!", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If
            MessageBox.Show("Técnico incluído com sucesso! Numero: " & _
                        objTecnicos_Implem.Codigo, "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Public Sub Alterar()
        ...
        Try
            ...
            wControle = GuardaDadosTecnicos()
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If

            wControle = objTecnicos_Implem.AlterarTecnico
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If
            MessageBox.Show("Dados do Técnico modificados com sucesso!", "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub Excluir()
        ...
        wMensagem = MessageBox.Show("TODOS Dados relacionados a esse Técnico serão permanentemente excluídos!" & vbCrLf & " Você deseja excluir este Técnico? ", "Confirmação", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button2)
        If (wMensagem = Windows.Forms.DialogResult.Yes) Then
            objTecnicos_Implem.Codigo = txtCodigo.Text
            wControle = objTecnicos_Implem.ExcluirTecnico
            If wControle < 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            ElseIf wControle = 1 Then
                MsgBox("Técnico Possui Movimento Ativo! ")
                Exit Sub
            End If
            MessageBox.Show("Técnico excluído com sucesso!", "Sucesso", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
        LimpaTela()
...
#Region " Atualização do DataGrid e do Form "
    ...
    Private Sub AtualizaTecnicos()
        ...
        wControle = objTecnicos_Implem.MostraTabelaTecnicos(dtgTecnicos, wSQL)
    ...
    Private Sub PreencheCampoPesquisa()
        If cbCampo.Items.Count = 0 Then
            ...
            For i As Integer = 0 To dtgTecnicos.Columns.Count - 1
                If dtgTecnicos.Columns(i).ValueType.ToString = GetType(String).ToString AndAlso dtgTecnicos.Columns(i).Visible = True Then
                    c = New System.Web.UI.WebControls.ListItem
                    c.Value = dtgTecnicos.Columns(i).HeaderText
                    c.Text = dtgTecnicos.Columns(i).HeaderText
                    cbCampo.Items.Add(c)
                End If
            Next
    ...
    Function FazFiltro()
        If Not IsNothing(dtgTecnicos.DataSource) Then
            ...
            For i As Integer = 0 To dtgTecnicos.Columns.Count - 1
                If dtgTecnicos.Columns(i).Name = cbCampo.Text Then
                    wValida = True
                    Exit For
                End If
            Next
            ...
            wDataTable = objTecnicos_Implem.wDataSet.Tables(0)
            Dim wDataView = New DataView(wDataTable, _
                     wPesquisa, _
                     "", DataViewRowState.CurrentRows)
            dtgTecnicos.DataSource = wDataView
        End If
        Return True
    End Function

    Private Sub dtgTecnicos_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles dtgTecnicos.MouseMove
        Try
            Dim hti As System.Windows.Forms.DataGridView.HitTestInfo
            hti = dtgTecnicos.HitTest(e.X, e.Y)
            ...
            If hti.Type = System.Windows.Forms.DataGrid.HitTestType.Cell Then
                ...
                End If
                If hti.ColumnIndex = 2 Then
                    ToolTip1.SetToolTip(dtgTecnicos, "")
                End If
            Else
                Me.Cursor = System.Windows.Forms.Cursors.Default
                Windows.Forms.Cursor.Current = System.Windows.Forms.Cursors.Default
    ...
    Private Sub dtgTecnicos_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles dtgTecnicos.MouseUp
        Try
            Dim hti As DataGridView.HitTestInfo = dtgTecnicos.HitTest(e.X, e.Y)
    ...
    Private Sub dtgTecnicos_CurrentCellChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtgTecnicos.CurrentCellChanged
        Try
            Dim wControle As Integer
            If IsNothing(dtgTecnicos.DataSource) Or IsNothing(dtgTecnicos.CurrentCell) Then Exit Sub

            objTecnicos_Implem.Codigo = dtgTecnicos.Item(0, dtgTecnicos.CurrentCell().RowIndex).Value
            wControle = objTecnicos_Implem.BuscarTecnico
            If wControle <> 0 Then
                objVariaveisGlobais.MostraErro()
                Exit Sub
            End If
            dtgTecnicos.Rows(dtgTecnicos.CurrentCell().RowIndex).Selected = True
            dtgTecnicos.Focus()
        Catch ex As Exception
            VariaveisGlobais.gUltimoSQL = ""
            VariaveisGlobais.gDescricaoUltimoErro = ex.Message
...
#Region " Valida da tela "
    ...
    Private Sub LimpaErros()
        ...
        ErrorProvider1.SetError(txtCRMV, "")
    ...
    Private Sub txtNome_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtNome.Validating
        Dim wMsgErro As String = "Digite o Nome do Técnico corretamente!"
    ...
    Private Sub txtCRMV_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtCRMV.Validating
        Dim wMsgErro As String = "Digite o CRMV do Técnico corretamente!"

        If txtCRMV.Text <> "" Then
            If Not IsNumeric(txtCRMV.Text) Then
                ErrorProvider1.SetError(txtCRMV, wMsgErro)
...
#End Region
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) _
        ...
        If mpreview = False Then
            ...
            dados = 0
        End If
        TotalRecords = dtgTecnicos.RowCount
    ...
    Private Sub PrintDocument2_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        For i As Integer = ContadorRegistro To TotalRecords - 1
            ...
            Codigo = dtgTecnicos.Item(0, i).Value
            Nome = dtgTecnicos.Item(1, i).Value
    ...
    Private Sub MontaCabecalho(ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        e.Graphics.DrawString("Relatório de Técnicos", printFontB, sdb, 390, 55, dFac)
        ...
        e.Graphics.DrawString("Nome do Técnico", printFontB, sdb, 80, 120)
